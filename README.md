...
```md
![Converter Topology](images/converter_topology.png)
```
...
Put images inside:
- hardware_setup.jpg
- hardware_waveforms.jpg
- pwm_waveforms.png
- converter_topology.png
- gate_driver.png
- inductor.jpg
- simulink_model.png
...
# 🖼️ Resize Images in GitHub README

```html
<p align="center">
<img src="images/converter_topology.png" width="700">
</p>
```
